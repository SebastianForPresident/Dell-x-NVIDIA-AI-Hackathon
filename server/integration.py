...
def project(service, investigation_id):
    ...
    return {"id": investigation_id, "claim_id": record["claim_id"], "investigation_id": investigation_id,
            ...
            "field_id": meta.get("field_id"), "farm_id": meta.get("farm_id"),
            "policy_id": meta.get("policy_id"), "field_name": meta.get("field_name", meta["field"]),
            "insured_crop": meta.get("insured_crop"), "insured_acres": meta.get("insured_acres"),
            "crop_year": meta.get("crop_year"),
            "local_evidence_available": meta.get("local_evidence_available"),
